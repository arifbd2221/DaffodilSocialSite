...
import com.socialsite.daffodilvarsity.adapters.holders.LoadViewHolder;
...
import com.socialsite.daffodilvarsity.enums.ItemType;
...
public class PostsAdapter extends BasePostsAdapter {
    ...
    public void loadFirstPage() {
        loadNext(0);
        PostManager.getInstance(mainActivity).clearNewPostsCounter();
    }
