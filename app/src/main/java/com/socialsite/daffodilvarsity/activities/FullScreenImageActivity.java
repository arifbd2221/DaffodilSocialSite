...
import com.socialsite.daffodilvarsity.views.TouchImageView;
    ...
    private void setValues(){
        ...
        Glide.with(this).load( urlPhotoClick).asBitmap().override(640,640).fitCenter().into(new SimpleTarget<Bitmap>() {
            ...
            public void onLoadFailed(Exception e, Drawable errorDrawable) {
                Toast.makeText(FullScreenImageActivity.this,"Erro, Failed To Load Image", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
    }
